...
(define (make-hardware-setup-adt)
  ...
  (define possible-switches (hash 'S-1 (make-switch-adt 'S-1 'right)
                                  'S-2-3 (make-switch-adt 'S-2 'right)
                                  ;'S-3 (make-switch-adt 'S-3 'right)
                                  'S-4 (make-switch-adt 'S-4 'right)
                                  'S-5 (make-switch-adt 'S-5 'left)
                                  'S-6 (make-switch-adt 'S-6 'left)
                                  'S-7 (make-switch-adt 'S-7 'left)
                                  'S-8 (make-switch-adt 'S-8 'right)
                                  'S-9 (make-switch-adt 'S-9 'left)
                                  'S-10 (make-switch-adt 'S-10 'right)
                                  'S-11 (make-switch-adt 'S-11 'right)
                                  'S-12 (make-switch-adt 'S-12 'left)
                                  'S-16 (make-switch-adt 'S-16 'left)
                                  'S-20 (make-switch-adt 'S-20 'left)
                                  'S-23 (make-switch-adt 'S-23 'right)
                                  'S-24 (make-switch-adt 'S-24 'left)
                                  'S-25 (make-switch-adt 'S-25 'right)
                                  'S-26 (make-switch-adt 'S-26 'right)
                                  'S-27 (make-switch-adt 'S-27 'left)
                                  'S-28 (make-switch-adt 'S-28 'left)))
