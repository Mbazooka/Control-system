...
(check-equal? (switch-1 'Incorrect-Message) "RAILROAD-SWITCH: Incorrect message")
(check-equal? (switch-2 'Incorrect-Message) "RAILROAD-SWITCH: Incorrect message")
(check-equal? (switch-3 'Incorrect-Message) "RAILROAD-SWITCH: Incorrect message")
