...
(define (main-loop)
  ...
  ((NMBS 'update-detection-blocks!) ((INFRABEL 'update-detection-blocks!)) ((INFRABEL 'retrieve-DB-reservations)))
  ((INFRABEL 'add-trajectories!) ((NMBS 'retrieve-trajectories)))
  (sleep 0.2)
  ((INFRABEL 'update-trains!) ((NMBS 'retrieve-all-trains)))
  (display "Here you can find the reservations: ")
  (display ((INFRABEL 'retrieve-DB-reservations)))
  (newline) (newline)
